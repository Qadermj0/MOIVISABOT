...
OCCUPATION_VARIANTS = {
    ...
    "مطور": ["مطور", "مطورة", "مطور تطبيقات", "مطورة تطبيقات", "مطور برامج", "مطورة برامج", "مطور برمجيات", "مطورة برمجيات", "مطور مواقع", "مطورة مواقع", "مبرمج", "مبرمج برمجيات", "مهندس برمجيات", "software developer", "app developer", "application developer", "mobile app developer", "developer", "programmer", "نظم المعلومات", "الشبكات", "الحاسوب", "الحاسب", "المواقع الالكترونيه", "المواقع الإلكترونية", "information systems", "networks", "computers", "electronic websites"],
    "مطور تطبيقات": ["مطور تطبيقات", "مطورة تطبيقات", "مطور برامج", "مطورة برامج", "مطور برمجيات", "مطورة برمجيات", "مطور مواقع", "مطورة مواقع", "مبرمج", "مبرمج برمجيات", "مهندس برمجيات", "software developer", "app developer", "application developer", "mobile app developer", "developer", "programmer", "نظم المعلومات", "الشبكات", "الحاسوب", "الحاسب", "المواقع الالكترونيه", "المواقع الإلكترونية", "information systems", "networks", "computers", "electronic websites"],
    "app developer": ["app developer", "application developer", "mobile app developer", "mobile developer", "software developer", "software engineer", "developer", "programmer", "مطور تطبيقات", "مطورة تطبيقات", "مطور برامج", "مطورة برامج", "مطور برمجيات", "مهندس برمجيات", "مبرمج", "نظم المعلومات", "الشبكات", "الحاسوب", "الحاسب", "المواقع الالكترونيه", "المواقع الإلكترونية", "information systems", "networks", "computers", "electronic websites"],
    ...
    "professor": ["professor", "professors", "استاذ", "استاذه", "استاذة", "اساتذه", "اساتذة", "استاذ جامعي", "اساتذه جامعيون", "الاساتذة الجامعيون", "teacher", "teachers", "instructor", "instructors", "educator", "educators", "معلم", "معلمه", "معلمة", "مدرس", "مدرسه", "مدرسة"],
    "استاذ": ["استاذ", "استاذه", "استاذة", "اساتذه", "اساتذة", "استاذ جامعي", "اساتذه جامعيون", "الاساتذة الجامعيون", "professor", "professors"],
    "teacher": ["teacher", "teachers", "instructor", "instructors", "educator", "educators", "معلم", "معلمه", "معلمة", "مدرس", "مدرسه", "مدرسة", "استاذ", "استاذه", "استاذة", "اساتذه", "اساتذة", "professor", "professors"],
    "instructor": ["instructor", "instructors", "teacher", "teachers", "educator", "educators", "معلم", "معلمه", "معلمة", "مدرس", "مدرسه", "مدرسة", "استاذ", "استاذه", "استاذة", "اساتذه", "اساتذة", "professor", "professors"],
    "educator": ["educator", "educators", "teacher", "teachers", "instructor", "instructors", "معلم", "معلمه", "معلمة", "مدرس", "مدرسه", "مدرسة", "استاذ", "استاذه", "استاذة", "اساتذه", "اساتذة", "professor", "professors"],
    "معلم": ["معلم", "معلمه", "معلمة", "مدرس", "مدرسه", "مدرسة", "استاذ", "استاذه", "استاذة", "اساتذه", "اساتذة", "teacher", "teachers", "instructor", "instructors", "educator", "educators", "professor", "professors"],
    "مدرس": ["مدرس", "مدرسه", "مدرسة", "معلم", "معلمه", "معلمة", "استاذ", "استاذه", "استاذة", "اساتذه", "اساتذة", "teacher", "teachers", "instructor", "instructors", "educator", "educators", "professor", "professors"],
